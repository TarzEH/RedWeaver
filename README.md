...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.10.1-00d4aa?style=flat-square" alt="Version" />
...
<p align="center">
  ...
  <sub>Behind the scenes — per-run debug: tool executions with raw output, agent steps, screenshots, event log, and the Attack playbook</sub>
</p>
...
│   │   ├── crews/               # CrewAI crews (bug_hunt + attack)
...
│       ├── hunts/               # Session, Target, Run + tasks.py (Celery), attack_tasks.py, consumers.py
...
- **Attack playbook** — a red-team agent turns findings into per-finding attack steps (commands + MITRE ATT&CK), grounded in the pgvector KB.
