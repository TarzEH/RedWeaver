...
class Run(TimeStampedUUIDModel):
    ...
    # Attack playbook (separate red-team agent, on-demand)
    attack_markdown = models.TextField(blank=True, default="")
    attack_status = models.CharField(max_length=16, default="none")  # none/queued/running/completed/failed
